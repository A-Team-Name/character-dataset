...
class Config:
    ...
    def get_translation(self, character_unicode: str) -> int:
        return self._get_attribute(character_unicode, "translation")

    def get_height(self, character_unicode: str) -> int:
        return self._get_attribute(character_unicode, "height")

    def get_padding(self, character_unicode: str) -> int:
        return self._get_attribute(character_unicode, "padding")
    
    def get_thickness(self, character_unicode: str) -> int:
        return self._get_attribute(character_unicode, "thickness")
    
    def get_stitch(self, character_unicode: str) -> str:
        return self._config_dict[character_unicode]["stitch"]
